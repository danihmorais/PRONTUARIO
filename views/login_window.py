...
class LoginWindow(ctk.CTk):
    ...
    def _build_ui(self):
        self.bg_img = ctk.CTkImage(
            light_image=Image.open(os.path.join(BASE_DIR, "assets", "BG_Inicial.png")),
            dark_image=Image.open(os.path.join(BASE_DIR, "assets", "BG_Inicial.png")),
            size=(579, 500)
        )
        self.lb_image = ctk.CTkLabel(self, image=self.bg_img, text="", fg_color=self._tm.c("WHITE"))
        self.lb_image.place(x=0, y=0)
        self.logo_img = ctk.CTkImage(
            light_image=Image.open(os.path.join(BASE_DIR, "assets", "logo.png")),
            dark_image=Image.open(os.path.join(BASE_DIR, "assets", "logo.png")),
            size=(70, 70)
        )
